    ...
    <div className="flex h-screen">
      ...
      <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
        <div className="max-w-md w-full p-6">
          ...
          <form onSubmit={onSignUp} method='post' className="space-y-4">
            <div>
              <label
                htmlFor="username"
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="terms" className="font-light text-gray-600 dark:text-gray-500">I accept the <Link className="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Terms and Conditions</Link></label>
              </div>
            </div>
            <div>
              {!loading ?
          ...
          <div className="mt-4 text-sm text-gray-600 text-center">
            <p>
              ...
              <Link href="/login" className='text-black hover:underline'>sign in here</Link>
            </p>
          </div>
        </div>
      </div>
